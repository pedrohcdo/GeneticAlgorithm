...
import ia.neuralnetwork.WeightInstancesCollection;
...
public class ReinforcementLearning {
	...
	Comparator<Genoma> mGenomaComparator = new Comparator<Genoma>() {
		...
		public int compare(Genoma o1, Genoma o2) {
			...
			Float f1 = o1.getFitness();
			Float f2 = o2.getFitness();
	 ...
	 *            Max PopulationSize
	 */
	public ReinforcementLearning(float mp, float mm, float cp, float dgp, int ms) {
